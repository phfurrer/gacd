...
This code book describes the variables, the data, and the transformations or work that has been done to clean up the data.
...
<h2>How to run_analysis.R</h2>
Just run the run_analysis.R script in R. All the transformations are executed within the script.
